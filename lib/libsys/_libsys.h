...
typedef int (__sys_cheri_cidcap_alloc_t)(void);
...
typedef int (__sys_cheri_revoke_get_shadow_t)(void);
typedef void * (__sys_cheri_revoke_t)(void);
typedef int (__sys_msetname_t)(void);
...
int __sys_cheri_cidcap_alloc(void);
...
int __sys_cheri_revoke_get_shadow(void);
void * __sys_cheri_revoke(void);
int __sys_msetname(void);
